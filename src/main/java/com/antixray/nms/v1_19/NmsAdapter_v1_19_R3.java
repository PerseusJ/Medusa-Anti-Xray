package com.antixray.nms.v1_19;
...
public class NmsAdapter_v1_19_R3 extends AbstractNmsAdapter {
    ...
    public NmsAdapter_v1_19_R3() {
        super(
            "v1_19_R3",
            new String[]{"a", "getPalette"},
            new String[]{"b", "getData", "getStorage", "c"},
    ...
    public void setPackedIndices(Object chunkSection, long[] indices, int bitsPerEntry) {
        try { Object pc = getPalettedContainer(chunkSection); if (pc == null) return; Object d = invokeMethod(palettedContainerGetData, pc);
            ...
            Method sm = findMethod(palettedContainerClass, new String[]{"a", "setData", "setStorage"}, false, Object.class); if (sm != null) sm.invoke(pc, (Object) indices); }
    ...
    public boolean isSingleValuePalette(Object chunkSection) {
        if (singleValuePaletteClass == null) return false;
        try { Object pc = getPalettedContainer(chunkSection); if (pc == null) return false; Object p = invokeMethod(palettedContainerGetPalette, pc); return singleValuePaletteClass.isInstance(p); } catch (Exception e) { return false; }
    }

    @Override
    public int getSingleValue(Object chunkSection) {
        if (singleValuePaletteClass == null) return 0;
    ...
    public void upgradeToIndirectPalette(Object chunkSection, int singleValue, int replacementValue) {
        if (singleValuePaletteClass == null) return;
        try { Object pc = getPalettedContainer(chunkSection); if (pc == null) return;
            ...
            Method sm = findMethod(palettedContainerClass, new String[]{"a", "setPalette"}, false, paletteClass, Object.class);
